...
struct ggml_metal_pipeline_with_params ggml_metal_library_get_pipeline_mul_mm            (ggml_metal_library_t lib, const struct ggml_tensor * op, bool bias, bool gelu);
...
struct ggml_metal_pipeline_with_params ggml_metal_library_get_pipeline_conv_transpose_2d_k2s2_fused(
        ggml_metal_library_t lib, const struct ggml_tensor * weight, bool apply_gelu);
